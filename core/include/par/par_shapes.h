    ...
    PAR_SHAPES_T* weldmap)
{
    ...
    float scale[3] = {
        static_cast<float>(aabb[3] == aabb[0] ? 1.0 : maxcell / (aabb[3] - aabb[0])),
        static_cast<float>(aabb[4] == aabb[1] ? 1.0 : maxcell / (aabb[4] - aabb[1])),
        static_cast<float>(aabb[5] == aabb[2] ? 1.0 : maxcell / (aabb[5] - aabb[2])),
    };
