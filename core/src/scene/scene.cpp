...
Scene::Scene(std::shared_ptr<TextureAssets> _textureAssets) : id(s_serial++), m_textureAssets(_textureAssets) {
...
Scene::Scene(const Scene& _other) : Scene(_other.m_textureAssets) {
